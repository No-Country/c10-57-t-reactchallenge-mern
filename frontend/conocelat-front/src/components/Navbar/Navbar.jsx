...
export const Navbar = () => {
    ...
    return (
        <nav className="shadow w-full fixed top-0 left-0">
            <div className="md:flex items-center justify-between bg-black px-8 py-4">
                <div className="flex items-center justify-between px-4 md:px-0">
                    ...
                    <button onClick={handleClick} className="menu focus:outline-none md:hidden">
                        {
                            menu
                                ? <RiCloseFill />
                                : <BiMenu />
